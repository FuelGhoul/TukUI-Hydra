...
for i = 1, 4 do
	...
	TukuiDB.CreatePanel(BarBackground[i], TukuiDB.Scale(120), TukuiDB.Scale(18), "CENTER", UIParent, "CENTER", 0, 0)
	if i == 1 then
...
for i = 1, 4 do
	...
	TukuiDB.CreatePanel(DatabarToggle[i], TukuiDB.Scale(120), TukuiDB.Scale(18), "CENTER", UIParent, "CENTER", 0, 0)
	if i == 1 then
...
for i = 1, 4 do
	...
	Text[i]:SetFont(TukuiCF.media.font, 12)
